                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <main class="text-center">
                        <div class="flex justify-center">
                            <img src="{{ asset('imagens/logo_Park_Garage.svg') }}" alt="Garage Park" class="h-auto">
                        </div>
                    </main>

                    <footer class="py-16 text-center text-sm text-black dark:text-white/70">
                        &copy; {{ date('Y') }} PARK GARAGE. All rights reserved. - Desenvolvimento &copy;ATITEC - Tecnologia: Laravel v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }})
                    </footer>
                </div>
            </div>
        </div>
